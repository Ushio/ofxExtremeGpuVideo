...
if ("%TBB_TARGET_ARCH%") == ("ia32") SET LIBRARY_PATH=%TBBROOT%\lib\android;%LIBRARY_PATH%
if ("%TBB_TARGET_ARCH%") == ("intel64") SET LIBRARY_PATH=%TBBROOT%\lib\android\x86_64;%LIBRARY_PATH%
